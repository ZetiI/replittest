...
const RegisterMyLostPet = () => {
  ...
  const nextStep = () => {
    ...
    if (currentStep === 1 && (!formState.allatfaj || !formState.allatneve)) {
  ...
  const renderStep1 = () => (
    <>
      ...
      <div className="col-span-2">
        ...
        <div className="relative w-full">
          ...
          <input
            ...
            className={`w-full pl-10 pr-3 py-3 text-lg border-2 ${theme === "dark" ? "border-gray-700 bg-gray-700 text-white" : "border-[#1A73E8] bg-white text-[#073F48]"} rounded-lg focus:outline-none focus:ring-2 ${theme === "dark" ? "focus:ring-gray-500" : "focus:ring-[#1A73E8]"} text-base`}
      ...
      <div className="col-span-2">
        ...
        <div className="relative w-full">
          <DatePicker
            ...
            className={`w-full pl-3 pr-3 py-3 text-lg border-2 ${theme === "dark" ? "border-gray-700 bg-gray-700 text-white" : "border-[#1A73E8] bg-white text-[#073F48]"} rounded-lg focus:outline-none focus:ring-2 ${theme === "dark" ? "focus:ring-gray-500" : "focus:ring-[#1A73E8]"} text-base`}
      ...
      {/* Next button - only visible on mobile */}
      {isMobile && (
        <div className="col-span-2 mt-4">
          <button
            onClick={nextStep}
            className={`w-full ${theme === "dark" ? "bg-gray-700 hover:bg-gray-600" : "bg-[#1A73E8] hover:bg-[#1557B0]"} text-white py-3 px-4 rounded-lg transition duration-300 text-lg font-semibold flex items-center justify-center`}
          >
    ...
    <>
      ...
      <div className="col-span-2">
        ...
        <div className="relative w-full">
          ...
          <textarea
            ...
            className={`w-full pl-10 pr-3 py-3 text-lg border-2 ${theme === "dark" ? "border-gray-700 bg-gray-700 text-white" : "border-[#1A73E8] bg-white text-[#073F48]"} rounded-lg focus:outline-none focus:ring-2 ${theme === "dark" ? "focus:ring-gray-500" : "focus:ring-[#1A73E8]"} text-base resize-none`}
      ...
      {isMobile && (
        <div className="col-span-2 grid grid-cols-2 gap-4">
          <button
            onClick={prevStep}
            className={`${theme === "dark" ? "bg-gray-700 hover:bg-gray-600" : "bg-gray-400 hover:bg-gray-500"} text-white py-3 px-4 rounded-lg transition duration-300 text-lg font-semibold flex items-center justify-center`}
          >
            <FaArrowLeft className="mr-2" /> Vissza
          </button>
          <button
            onClick={regAnimal}
            className={`${theme === "dark" ? "bg-gray-700 hover:bg-gray-600" : "bg-[#1A73E8] hover:bg-[#1557B0]"} text-white py-3 px-4 rounded-lg transition duration-300 text-lg font-semibold flex items-center justify-center`}
          >
            Adatfelvitel
          </button>
        </div>
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center ${theme === "dark" ? "bg-gray-900" : "bg-gradient-to-r from-[#64B6FF] to-[#A7D8FF]"} pt-20 pb-8 px-4`}>
      {/* Main Form Container */}
      <div className={`${theme === "dark" ? "bg-gray-800" : "bg-[#F0EDEE]"} p-6 rounded-3xl shadow-xl w-full max-w-lg border-2 ${theme === "dark" ? "border-gray-700" : "border-[#1A73E8]"} mt-8`}>
        <h1 className={`text-3xl font-bold text-center ${theme === "dark" ? "text-white" : "text-[#073F48]"}`}>
          Elveszett állat adatai
          {isMobile && (
            <span className="block text-sm font-normal mt-1">
              {currentStep === 1 ? "1/2 - Alapadatok" : "2/2 - További információk"}
            </span>
          )}
        </h1>
        
        {/* Responsive Grid - shows steps on mobile, all fields on desktop */}
        <div className={`grid ${isMobile ? 'grid-cols-1' : 'grid-cols-2'} gap-4 mt-6`}>
          {isMobile ? (
            currentStep === 1 ? renderStep1() : renderStep2()
          ) : (
            <>
              {/* Desktop view shows all fields at once */}
              {renderStep1()}
              {renderStep2()}
            </>
          )}
      ...
      {/* Jobb oldal: Kép és inspiráló szöveg - Only visible on xl screens */}
      {!isMobile && (
